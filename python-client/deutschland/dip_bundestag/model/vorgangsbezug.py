...
class Vorgangsbezug(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, titel, vorgangstyp, *args, **kwargs):  # noqa: E501
        """Vorgangsbezug - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, titel, vorgangstyp, *args, **kwargs):  # noqa: E501
        """Vorgangsbezug - a model defined in OpenAPI
