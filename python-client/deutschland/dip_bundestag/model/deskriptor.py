...
class Deskriptor(ModelNormal):
    ...
    allowed_values = {
        ("typ",): {
            ...
            "GEOGRAPH._BEGRIFFE": "Geograph. Begriffe",
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, typ, *args, **kwargs):  # noqa: E501
        """Deskriptor - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, typ, *args, **kwargs):  # noqa: E501
        """Deskriptor - a model defined in OpenAPI
