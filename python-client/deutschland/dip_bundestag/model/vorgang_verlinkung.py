...
class VorgangVerlinkung(ModelNormal):
    ...
    attribute_map = {
        "id": "id",  # noqa: E501
        "verweisung": "verweisung",  # noqa: E501
    ...
    def _from_openapi_data(
        cls, id, verweisung, titel, wahlperiode, *args, **kwargs
    ):  # noqa: E501
        """VorgangVerlinkung - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, id, verweisung, titel, wahlperiode, *args, **kwargs
    ):  # noqa: E501
        """VorgangVerlinkung - a model defined in OpenAPI
