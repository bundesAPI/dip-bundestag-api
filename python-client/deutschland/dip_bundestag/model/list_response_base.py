...
class ListResponseBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, num_found, cursor, *args, **kwargs):  # noqa: E501
        """ListResponseBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, num_found, cursor, *args, **kwargs):  # noqa: E501
        """ListResponseBase - a model defined in OpenAPI
