...
class GetVorgang404Response(ModelNormal):
    ...
    def _from_openapi_data(cls, message, *args, **kwargs):  # noqa: E501
        """GetVorgang404Response - a model defined in OpenAPI

        Args:
            message (str):

        Keyword Args:
            code (int): defaults to 404, must be one of [404, ]  # noqa: E501
