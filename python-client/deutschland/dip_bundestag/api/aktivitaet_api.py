...
class AktivitaetApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.aktivitaet_endpoint = _Endpoint(
            settings={
                "response_type": (
                    {
                        str: (
        ...
        self.aktivitaet_id_endpoint = _Endpoint(
            settings={
                "response_type": (
                    {
                        str: (
    ...
    def aktivitaet(self, **kwargs):
        ...
        >>> thread = api.aktivitaet(async_req=True)
        >>> result = thread.get()
        ...
        return self.aktivitaet_endpoint.call_with_http_info(**kwargs)

    def aktivitaet_id(self, id, **kwargs):
        ...
        >>> thread = api.aktivitaet_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["id"] = id
        return self.aktivitaet_id_endpoint.call_with_http_info(**kwargs)
