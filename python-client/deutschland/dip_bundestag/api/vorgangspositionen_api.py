...
class VorgangspositionenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_vorgangsposition_endpoint = _Endpoint(
            settings={
                "response_type": (Vorgangsposition,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/vorgangsposition/{id}",
                "operation_id": "get_vorgangsposition",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.get_vorgangsposition_list_endpoint = _Endpoint(
            settings={
                "response_type": (VorgangspositionListResponse,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/vorgangsposition",
                "operation_id": "get_vorgangsposition_list",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def get_vorgangsposition(self, id, **kwargs):
        """Liefert Metadaten zu einer Vorgangsposition  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vorgangsposition(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["id"] = id
        return self.get_vorgangsposition_endpoint.call_with_http_info(**kwargs)

    def get_vorgangsposition_list(self, **kwargs):
        """Liefert eine Liste von Metadaten zu Vorgangspositionen  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vorgangsposition_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        return self.get_vorgangsposition_list_endpoint.call_with_http_info(**kwargs)
