...
class PlenarprotokolleApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_plenarprotokoll_endpoint = _Endpoint(
            settings={
                "response_type": (Plenarprotokoll,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/plenarprotokoll/{id}",
                "operation_id": "get_plenarprotokoll",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.get_plenarprotokoll_list_endpoint = _Endpoint(
            settings={
                "response_type": (PlenarprotokollListResponse,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/plenarprotokoll",
                "operation_id": "get_plenarprotokoll_list",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.get_plenarprotokoll_text_endpoint = _Endpoint(
            settings={
                "response_type": (PlenarprotokollText,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/plenarprotokoll-text/{id}",
                "operation_id": "get_plenarprotokoll_text",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.get_plenarprotokoll_text_list_endpoint = _Endpoint(
            settings={
                "response_type": (PlenarprotokollTextListResponse,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/plenarprotokoll-text",
                "operation_id": "get_plenarprotokoll_text_list",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def get_plenarprotokoll(self, id, **kwargs):
        """Liefert Metadaten zu einem Plenarprotokoll  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_plenarprotokoll(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["id"] = id
        return self.get_plenarprotokoll_endpoint.call_with_http_info(**kwargs)

    def get_plenarprotokoll_list(self, **kwargs):
        """Liefert eine Liste von Metadaten zu Plenarprotokollen  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_plenarprotokoll_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        return self.get_plenarprotokoll_list_endpoint.call_with_http_info(**kwargs)

    def get_plenarprotokoll_text(self, id, **kwargs):
        """Liefert Volltext und Metadaten zu einem Plenarprotokoll  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_plenarprotokoll_text(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["id"] = id
        return self.get_plenarprotokoll_text_endpoint.call_with_http_info(**kwargs)

    def get_plenarprotokoll_text_list(self, **kwargs):
        """Liefert eine Liste von Volltexten und Metadaten zu Plenarprotokollen  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_plenarprotokoll_text_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        return self.get_plenarprotokoll_text_list_endpoint.call_with_http_info(**kwargs)
