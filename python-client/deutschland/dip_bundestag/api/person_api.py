...
class PersonApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.person_endpoint = _Endpoint(
            settings={
                "response_type": (
                    {
                        str: (
        ...
        self.person_id_endpoint = _Endpoint(
            settings={
                "response_type": (
                    {
                        str: (
                ...
                "auth": ["ApiKeyAuth"],
                "endpoint_path": "/person/{id}",
                "operation_id": "person_id",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def person(self, **kwargs):
        ...
        >>> thread = api.person(async_req=True)
        >>> result = thread.get()
        ...
        return self.person_endpoint.call_with_http_info(**kwargs)

    def person_id(self, id, **kwargs):
        ...
        >>> thread = api.person_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["id"] = id
        return self.person_id_endpoint.call_with_http_info(**kwargs)
