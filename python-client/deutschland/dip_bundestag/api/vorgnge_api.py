...
class VorgngeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_vorgang_endpoint = _Endpoint(
            settings={
                "response_type": (Vorgang,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/vorgang/{id}",
                "operation_id": "get_vorgang",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
        ...
        self.get_vorgang_list_endpoint = _Endpoint(
            settings={
                "response_type": (VorgangListResponse,),
                "auth": ["ApiKeyHeader", "ApiKeyQuery"],
                "endpoint_path": "/vorgang",
                "operation_id": "get_vorgang_list",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def get_vorgang(self, id, **kwargs):
        """Liefert Metadaten zu einem Vorgang  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vorgang(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["id"] = id
        return self.get_vorgang_endpoint.call_with_http_info(**kwargs)

    def get_vorgang_list(self, **kwargs):
        """Liefert eine Liste von Metadaten zu Vorgängen  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vorgang_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        return self.get_vorgang_list_endpoint.call_with_http_info(**kwargs)
