...
import urllib3
from deutschland.dip_bundestag.exceptions import ApiValueError
...
class Configuration(object):
    ...
    conf = dip_bundestag.Configuration(
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = (
            "https://search.dip.bundestag.de/api/v1" if host is None else host
        )
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("dip_bundestag")
